...
MILLEIO myADC121S021IO(LIGHT_ADDRESS,myWire,&infoADC12_0,0); //get device IO information MILLEIO, connector number on baseboard is zero.ベースボードのコネクタ番号0につながっているデバイスの配線情報を呼び出します。
